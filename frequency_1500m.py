...
direction = 24 #1500m level
Speed = 23 #1500m level
...
print("!-----1500m UPPER WIND FREQUENCY-----!") 
print("-------------------------------------")            
print(f"CALM 1500M : {Calm_1500m}")
...
print(f"Higher 20.5 N : {Level_4_N} | Higher 20.5 NE : {Level_4_NE} | Higher 20.5 E : {Level_4_E} | Higher 20.5 SE : {Level_4_SE} | Higher 20.5 S : {Level_4_S} | Higher 20.5 SW : {Level_4_SW} | Higher 20.5 W : {Level_4_W} | Higher 20.5 NW : {Level_4_NW} ") 
print("-------------------------------------")
